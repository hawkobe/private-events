...
ActiveRecord::Schema[8.0].define(version: 2025_05_17_073653) do
  ...
  create_table "event_invitations", force: :cascade do |t|
    ...
    t.integer "guest_invited_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["guest_invited_id"], name: "index_event_invitations_on_guest_invited_id"
  ...
  add_foreign_key "event_invitations", "users", column: "guest_invited_id"
